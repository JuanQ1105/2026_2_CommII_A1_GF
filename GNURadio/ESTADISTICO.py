...
class ESTADISTICO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ESTADISTICO")
        ...
        self.qtgui_number_sink_0_3.set_title("MEDIA CUADRATICA")
        ...
        self.connect((self.epy_block_0, 1), (self.qtgui_number_sink_0_3, 0))
...
def main(top_block_cls=ESTADISTICO, options=None):
